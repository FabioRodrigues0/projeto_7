...
public class LobbyView extends BricksScene {

    private final LobbyViewModel vm;

    public LobbyView(BricksApplication app, LobbyViewModel vm) {
        super(app);
        use(vm);
        this.vm = vm;
        ...
        return new Column()
            ...
            .children(
                ...
                new Button("Entrar como Aluno").onClick(() ->
                    app.navigateTo(
                        new AlunoView(app, new AlunoViewModel(), vm.alunoSelecionado.get())
                    )
                )
            );
    }
